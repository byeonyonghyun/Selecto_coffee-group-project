...
const createItem = function (store) {
  ...
  attr.value = store.src;
  img.setAttributeNode(attr);

  tr.innerHTML = `
  <td class=store_nm>${store.name}</td>
  <td class=store_loc>${store.locate}</td>
  <td class=store_adr>${store.adrress}</td>
  <td class=store_tel>${store.tel}</td>
  <td class=store_srv>${store.srv}</td>
  `
